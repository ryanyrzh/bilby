...
def main():
    ...
    injection_parameters = generic_gwfast_to_bilby_lensed(simple_gwfast, agn_injection)
    print('Simple lensing injection parameters (converted from AGN parameters):')
